package com.test.pamcase.security;
...
*/
	 ...
	 @Override //added to disable cross you have to disable csrf Protection because it is enabled by default in spring 
	 //security: here you can see code that allow cors origin.
	    protected void configure(HttpSecurity http) throws Exception{
